...
public:
    ...
    QRadioButton *westGateValveRadio;
    QRadioButton *roundhouseGateValveRadio;
    QRadioButton *cleanerRadio;
    QRadioButton *giantCleanerRadio;
    ...
    void setupUi(QMainWindow *ControlGUI)
    {
        ...
        westGateValveRadio = new QRadioButton(frame);
        westGateValveRadio->setObjectName(QStringLiteral("westGateValveRadio"));
        westGateValveRadio->setAutoExclusive(false);

        verticalLayout_5->addWidget(westGateValveRadio);

        roundhouseGateValveRadio = new QRadioButton(frame);
        roundhouseGateValveRadio->setObjectName(QStringLiteral("roundhouseGateValveRadio"));

        verticalLayout_5->addWidget(roundhouseGateValveRadio);
        ...
        giantCleanerRadio = new QRadioButton(frame);
        giantCleanerRadio->setObjectName(QStringLiteral("giantCleanerRadio"));
        giantCleanerRadio->setEnabled(true);
        giantCleanerRadio->setAutoExclusive(false);

        verticalLayout_5->addWidget(giantCleanerRadio);
        ...
        giantCleanerSpinBox->setMaximum(2e+7);
    ...
    {
        ControlGUI->setWindowTitle(QApplication::translate("ControlGUI", "ControlGUI", Q_NULLPTR));
        openFileButton->setText(QApplication::translate("ControlGUI", "Open Run File", Q_NULLPTR));
        waitForGoCheckbox->setText(QApplication::translate("ControlGUI", "Wait for MPA3 Go", Q_NULLPTR));
        waitForHmGXCheckBox->setText(QApplication::translate("ControlGUI", "Wait for H-GX", Q_NULLPTR));
        startMidasCheckbox->setText(QApplication::translate("ControlGUI", "Start MIDAS", Q_NULLPTR));
        fillCheckCheckbox->setText(QApplication::translate("ControlGUI", "Monitor Fills", Q_NULLPTR));
        startButton->setText(QApplication::translate("ControlGUI", "Start", Q_NULLPTR));
        abortButton->setText(QApplication::translate("ControlGUI", "Abort", Q_NULLPTR));
        stopAfterThisRunCheckBox->setText(QApplication::translate("ControlGUI", "Stop after this run", Q_NULLPTR));
        label_7->setText(QApplication::translate("ControlGUI", "Cycle Period (s)", Q_NULLPTR));
        label_6->setText(QApplication::translate("ControlGUI", "Elapsed Time (s)", Q_NULLPTR));
        label_2->setText(QApplication::translate("ControlGUI", "List number", Q_NULLPTR));
        loadfileNumber_button->setText(QApplication::translate("ControlGUI", "Load File Number", Q_NULLPTR));
        label_5->setText(QApplication::translate("ControlGUI", "Present State", Q_NULLPTR));
        beamEnableRadio->setText(QApplication::translate("ControlGUI", "Beam Veto", Q_NULLPTR));
        westGateValveRadio->setText(QApplication::translate("ControlGUI", "West Gate Valve Open", Q_NULLPTR));
        roundhouseGateValveRadio->setText(QApplication::translate("ControlGUI", "RH Gate Valve Open", Q_NULLPTR));
        cleanerRadio->setText(QApplication::translate("ControlGUI", "Cleaner Down", Q_NULLPTR));
        giantCleanerRadio->setText(QApplication::translate("ControlGUI", "Giant Cleaner Down", Q_NULLPTR));
        butterflyRadio->setText(QApplication::translate("ControlGUI", "Butterfly Closed", Q_NULLPTR));
        nEDMGVButton->setText(QApplication::translate("ControlGUI", "Enable other experiments", Q_NULLPTR));
        label->setText(QApplication::translate("ControlGUI", "Trap Door", Q_NULLPTR));
        trapdoorComboBox->clear();
        trapdoorComboBox->insertItems(0, QStringList()
         << QApplication::translate("ControlGUI", "DONT KNOW", Q_NULLPTR)
         << QApplication::translate("ControlGUI", "FILL", Q_NULLPTR)
         << QApplication::translate("ControlGUI", "HOLD", Q_NULLPTR)
         << QApplication::translate("ControlGUI", "DUMP", Q_NULLPTR)
         << QApplication::translate("ControlGUI", "UP", Q_NULLPTR)
        );
        label_8->setText(QApplication::translate("ControlGUI", "Dagger Position (steps)", Q_NULLPTR));
        daggerPushButton->setText(QApplication::translate("ControlGUI", "Set", Q_NULLPTR));
        label_9->setText(QApplication::translate("ControlGUI", "Giant Cleaner Position (steps)", Q_NULLPTR));
        giantCleanerPushButton->setText(QApplication::translate("ControlGUI", "Set", Q_NULLPTR));
    } // retranslateUi
